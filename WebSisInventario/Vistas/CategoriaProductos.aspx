            ...
            <form runat="server" id="form1">
                <div class="formularios">
                    <asp:PlaceHolder runat="server" ID="placeHolderProducto">
                        ...
                        <br />
                        <asp:TextBox runat="server" ID="txtCodigo" CssClass="campoTexto" />
                        <br />
                        <asp:Label ID="lblProducto" Text="Producto:" runat="server" />
                          <br />
                         <asp:TextBox runat="server" ID="txtProducto" CssClass="campoTexto" />
                        <br />
                        <asp:Label ID="lblPrecio" Text="Precio:" runat="server" />
                           <br />
                        <asp:TextBox runat="server" ID="txtPrecio" CssClass="campoTexto" />
                        <br />
                    ...
                    <asp:PlaceHolder runat="server" ID="placeHolderCategoria">
                        ...
                        <br />
                        <asp:TextBox runat="server"  id="txtCategoria" CssClass="campoTexto"/>
                        <br />
                        <br />
                        <br />
                        <br />
                    ...
                    <asp:Button Text="Guardar." ID="btnGuardar" BorderStyle="None" CssClass="button" runat="server" />
                     ...
                     <asp:Button Text="Cancelar." ID="btnCancelar" BorderStyle="None" CssClass="button" runat="server" />
                    <br />
                    <br />
                </div>
                ...
                <div class="formularios">
                    ...
                    <asp:Button ID="ButtonTipo" runat="server" BorderStyle="None" CssClass="button" Text="Tipo." />
